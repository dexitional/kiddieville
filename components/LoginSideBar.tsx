  ...
  return (
    <div className="relative w-[30%] h-full hidden md:flex flex-col justify-between bg-green-900 font-circular">
        ...
        <div className="p-8 z-10 flex flex-col text-white space-y-6 font-circular">
          <img src={Logo.src} className="w-36 h-36 object-contain filter mix-blend-screen rounded opacity-70"/>
          <h1 className="text-3xl font-bold">Welcome to <span className="text-yellow-400">KIDDIE VILLE</span><br/>Student Mangement System</h1>
